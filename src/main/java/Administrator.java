...
public class Administrator extends User {
	...
	/** The administrator's menu. Several options are available. 
  ...
  private void deleteUserMenu() {
	  ...
	  for (;;) {
		  try {
			  System.out.print("Enter the id of the user you want to delete. To cancel press \"enter\": "); 
			  ans = in.nextLine();
			  if (ans.equals("")) {
			  ...
			  System.out.print("Deleting a user is permanent. Are you sure you want to delete a user?\n"
  ...
  private void changeUserPasswordMenu() {
	Scanner in = new Scanner(System.in);
	  ...
	  for (;;) {
		  try {
			  System.out.print("Enter the id of the user you want to change. To cancel press \"enter\": "); 
			  ans = in.nextLine();
			  if (ans.equals("")) {
				  System.out.println("Process cancelled. Returning to previous menu..." );
				  return;
	...
	for (;;) {
		...
		for (;;) {
			...
			if (usernameAlreadyExists(username) == false) {
				...
				System.out.println("User with such username already exists. Try again with an other username..."); 
			}
		} 
		for (;;) {
			System.out.print("Enter the user's password."
		...
		for (;;) {
			try {
				System.out.print("What is the type of the user? \n"
					    + "1) Cashier\n"
					    + "2) Storekeeper\n"
					    + "3) Data Analyst\n"
					    + "4) Administrator\n"
